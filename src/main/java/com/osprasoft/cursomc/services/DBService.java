...
import com.osprasoft.cursomc.domain.Pagamento;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "igor.minoru@outlook.com", "12345678900",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("987542136", "963524187"));
		cli1.addPerfil(Perfil.CLIENTE);

		Cliente cli2 = new Cliente(null, "Ana Costa", "igor.minoru@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,
				pe.encode("456"));
		...
		Pedido ped2 = new Pedido(null, instantePedido.parse("10/10/2017 19:35"), cli1, e2);

		Pagamento pagto1 = new PagamentoCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		Pagamento pagto2 = new PagamentoBoleto(null, EstadoPagamento.PENDENTE, ped2,
				instantePedido.parse("20/10/2017 00:00"), null);
